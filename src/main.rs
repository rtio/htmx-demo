...
use rocket::{Request, fs::{TempFile, FileServer, relative, NamedFile}, form::Form, tokio::fs::File, http::ContentType, response::Redirect};
...
fn rocket() -> _ {
    ...
    rocket::build()
        .mount("/", routes![index, upload, retrieve, resize_image, retrieve_original])
